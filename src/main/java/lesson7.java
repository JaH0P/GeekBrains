...
public class lesson7 {
    ...
    public static void main(String[] args) {
        int action;
        Cati[] allCats = new Cati[4];
        allCats[0] = new Cati("Барсик", 5, false);
        allCats[1] = new Cati("Снежок", 30, false);
        allCats[2] = new Cati("Мурзик", 10, false);
        allCats[3] = new Cati("Чернышка", 45, false);
